...
네트워크 연결상태를 감지해서 연결이 끊어졌을시 웹사이트가 멈추는것이 아니라 오프라인에서도 우리의 서비스를특정한 이벤트를 발생시키는 등의 백그라운드에서 동작하는 작업들은 **"서비스워커"** 가 도맡아 처리합니다.
...
> [목차](#목차)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ3MTQ5NTM3MSwtMTQwMTAwMTAzOCwtMT
