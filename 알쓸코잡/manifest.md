...
이때 네트워크 상태를 감시하고 네트워크가 연결이 끊어진 상황에서 특정 화면을 보여주도록 해주는 작업과 오프라인시 발생된 요청들을 저장해두었다가 네트워크 활성화와 함께 순차적으로 처리해주는 작업은 **"서비스워커"** 가 도맡아 처리합니다.
...
> [목차](#목차)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM2MjkwMjMzNCwtMTQwMTAwMTAzOCwtMT
